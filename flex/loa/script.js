async function generatePDF() {
    ...
    // Subtitle
    pdf.setFontSize(12);
    pdf.text("Between " + employeeName + " and Flex Networks", 105, 30, null, null, "center");
    pdf.setFontSize(10);
...
By signing below, both parties acknowledge and agree to the terms and conditions set forth in this LOA Agreement.
    ...
    pdf.text("Signature: ______________________ Date: __________", 20, yPosition + 30);

    pdf.text("For Flex Networks (Authorized Representative):", 20, yPosition + 40);
    pdf.text("Signature: ______________________ Date: __________", 20, yPosition + 50);
